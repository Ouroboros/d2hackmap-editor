const zhCN: Record<string, string> = {
  ...
  'subTab.runes': '符文颜色',
  'subTab.golds': '金币颜色',
  'subTab.monsters': '怪物颜色',
  'subTab.skillMissiles': '弹道颜色',
  'subTab.magicBags': '魔法口袋',
  ...
  'itemColors.etherealTitle': '选择无形',
  'itemColors.etherealNo': '否',
  'itemColors.etherealYes': '是',
  'itemColors.sockets': '孔数',
  'itemColors.socketsTitle': '选择孔数',
  ...
  'itemColors.monsterId': '怪物ID',
  'itemColors.monsterType': '怪物类型',
  'itemColors.monsterEmpty': '没有怪物颜色配置',
  'itemColors.skillId': '技能ID',
  'itemColors.drawMode': '显示模式',
  'itemColors.skillMissileEmpty': '没有技能弹道显示配置',
  'itemColors.magicBagIndex': '口袋范围',
  'itemColors.magicBagItem': '第一个物品ID',
  'itemColors.magicBagName': '名字',
  'itemColors.magicBagEmpty': '没有魔法口袋名称配置',
  ...
  'gen.runeColors': '符文颜色',
  'gen.goldColors': '金币颜色',
  'gen.monsterColors': '怪物颜色',
  'gen.skillMissileDrawModes': '弹道颜色',
  'gen.magicBagNames': '魔法口袋名称',
